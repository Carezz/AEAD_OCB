...
#define NONCE "BBAA9988776655443322110D"
#define NONCE_STR_LEN sizeof(NONCE)
#define NONCE_LEN NONCE_STR_LEN / 2

#define AD "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F2021222324252627" 
#define AD_STR_LEN sizeof(AD)
#define AD_LEN AD_STR_LEN / 2

#define PLAINTEXT "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F2021222324252627"  
#define PLAINTEXT_STR_LEN sizeof(PLAINTEXT)
#define PLAINTEXT_LEN PLAINTEXT_STR_LEN / 2

#define EXP_CIPHERTEXT "D5CA91748410C1751FF8A2F618255B68A0A12E093FF454606E59F9C1D0DDC54B65E8628E568BAD7AED07BA06A4A69483A7035490C5769E60" 
